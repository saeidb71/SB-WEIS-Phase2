...
if __name__ == '__main__':
    ...
    run_dir2                    = run_dir1 + os.sep
    fastBatch.FAST_directory    = os.path.join(run_dir2, 'outputs','03_NREL5MW_OC3_spar')   # Path to fst directory files
    fastBatch.FAST_InputFile    = 'NREL5MW_OC3_spar_0.fst'   # FAST input file (ext=.fst)
    fastBatch.FAST_runDirectory = fastBatch.FAST_directory+os.sep+'runOpenFAST/Fast5mw'
    fastBatch.debug_level       = 2

    # User settings
    n_cores     = 6     # Number of available cores
    TMax        = 120.0  # Length of wind grids and OpenFAST simulations, suggested 720 s
